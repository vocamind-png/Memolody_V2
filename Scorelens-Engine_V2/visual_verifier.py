...
from Scorelens_Engine_V2.utils import get_unit_size, get_global_unit_size, get_logger, find_closest_staffs
from Scorelens_Engine_V2.bbox import get_center, get_bbox, rm_merge_overlap_bbox
from Scorelens_Engine_V2.notehead_extraction import NoteType, NoteHead
from Scorelens_Engine_V2.symbol_extraction import SfnType
...
def _recount_beams_in_image(note, beam_map):
    ...
    """
    from Scorelens_Engine_V2.rhythm_extraction import scan_beam_flag
...
def verify_measure_duration(measures_dict, time_sig):
    ...
    from Scorelens_Engine_V2.build_system import DIVISION_PER_QUATER
