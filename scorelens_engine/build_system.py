...
from scorelens_engine.symbol_extraction import Barline, Clef, Sfn, Rest, SfnType, ClefType, RestType
from scorelens_engine.note_group_extraction import NoteGroup
from scorelens_engine.notehead_extraction import NoteHead, NoteType
from scorelens_engine.utils import get_global_unit_size, get_logger, get_total_track_nums
...
class MusicXMLBuilder:
    def __init__(self, title=None):
        ...
        self.time_sig: tuple[int, int] = (4, 4)  # Will be set by build()
    ...
    def build(self):
        ...
        # ── Infer time signature from rhythm data ──
